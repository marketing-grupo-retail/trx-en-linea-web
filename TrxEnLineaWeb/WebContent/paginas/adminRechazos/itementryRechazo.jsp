...
<html:form method="post" action="/init_itementry_rechazos"
	styleId="stringForm">
	...
	<logic:present name="dynamicITForm" property="it_string">
		<bean:size id="size" name="dynamicITForm" property="it_string" />
		...
		<logic:greaterThan value="0" name="size">
			<table>
				<logic:present name="parametros_strings" scope="application">
					...
					Hashtable hashCampos_ = (Hashtable) hash_.get("tx_itementry");
					...
					<logic:present name="list_campos" scope="request">
						...
						<logic:iterate id="element" name="list_campos">
							<tr>
								...
								<logic:iterate id="it_string" name="dynamicITForm"
									property="it_string" indexId="i"
									type="com.asic.transacciones.vo.TX_ITEMENTRY_Imp">
									<td class="EnlacesMenuSubSmall" align="center"><html:text
										name="it_string" indexed="true"
										property='<%=("" + element).toUpperCase()%>'>
										<bean:write name="it_string"
											property='<%=("" + element).toUpperCase()%>' />
									</html:text></td>
								</logic:iterate>
							</tr>
