...
<html:form method="post" action="/init_dataentry_rechazos"
	styleId="stringForm">
	...
	<logic:present name="dynamicDEForm" property="de_string">
		<bean:size id="size" name="dynamicDEForm" property="de_string" />
		...
		<logic:greaterThan value="0" name="size">
			<table>
				<logic:present name="parametros_strings" scope="application">
					...
					Hashtable hashCampos_ = (Hashtable) hash_.get("tx_data_entry");
					...
					<logic:present name="list_campos" scope="request">
						...
						<logic:iterate id="element" name="list_campos">
							<tr>
								...
								<logic:iterate id="de_string" name="dynamicDEForm"
									property="de_string" indexId="i"
									type="com.asic.transacciones.vo.TX_DATA_ENTRY_Imp">
									<td class="EnlacesMenuSubSmall" align="center"><html:text
										name="de_string" indexed="true"
										property='<%=("" + element).toUpperCase()%>'>
										<bean:write name="de_string"
											property='<%=("" + element).toUpperCase()%>' />
									</html:text></td>
								</logic:iterate>
							</tr>
