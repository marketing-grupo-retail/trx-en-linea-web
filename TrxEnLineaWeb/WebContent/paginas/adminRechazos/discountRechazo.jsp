...
<html:form method="post" action="/init_discount_rechazos"
	...
	<logic:present name="dynamicDSForm" property="ds_string">
		<bean:size id="size" name="dynamicDSForm" property="ds_string" />
					...
					<logic:present name="list_campos" scope="request">
						...
						<logic:iterate id="element" name="list_campos">
							<tr>
								...
								<logic:iterate id="ds_string" name="dynamicDSForm"
									property="ds_string" indexId="i"
									type="com.asic.transacciones.vo.TX_DISCOUNT_Imp">
									<td class="EnlacesMenuSubSmall" align="center"><html:text
										name="ds_string" indexed="true"
										property='<%=("" + element).toUpperCase()%>'>
										<bean:write name="ds_string"
											property='<%=("" + element).toUpperCase()%>' />
									</html:text></td>
								</logic:iterate>
							</tr>
