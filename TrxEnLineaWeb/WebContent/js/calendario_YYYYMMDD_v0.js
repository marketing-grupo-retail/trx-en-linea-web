...
function seleccionarFechaYYYYMMDD( elemento, pFormato ){
	formato = pFormato
...
function cal_popup1 (str_datetime) {
	...
	var obj_calwindow = window.open(
		'../_common/calendar.html?datetime=' + this.dt_current.valueOf()+ '&id=' + this.id +'&comp_date=' + this.comp_date +'&n_days=' + this.n_days,
		'Calendar', 'width=200,height='+(this.time_comp ? 315 : 180)+
...
function cal_prs_date1 (str_date) {
	...
	if(arr_date.length == 2){
		...
		dt_date.setFullYear(arr_date[1]);
	}	
	...
	/*ACA SE PONE LA FECHA DEL CAMPO
