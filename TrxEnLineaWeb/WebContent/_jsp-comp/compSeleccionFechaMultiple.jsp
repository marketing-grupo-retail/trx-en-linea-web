<%-- VisaWeb:  $Id: compSeleccionFechaMultiple.jsp,v 1.1 2019/12/18 17:30:58 Alfonso Exp $ --%>

<!-- INICIO: COMPONENTE PARA SELECCION DE RANGO
pre:
	obj seleccionRango_theForm
	obj	seleccionRango_theForm.fechaInicialTxt
	obj	seleccionRango_theForm.fechaFinalTxt
	lib js/common.js	
pos:
	seleccionRango_theForm.fecha
...
<INPUT type="image"
	...
	onclick="popUpCalendar(this, seleccionRango_theForm.fechaInicialTxt, defaultDateFormat, compSeleccionFecha_update); return false;"
	alt="Fecha">
