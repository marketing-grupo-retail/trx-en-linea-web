 ...
 * Ventana&gt;Preferencias&gt;Java&gt;Generación de código&gt;Código y comentarios
 */
public class SodOperatorTrainingTrama extends OperatorTrainingString {
	
	private TX_OPERATOR_TRAINING stringRecord;

	public SodOperatorTrainingTrama(String pRecord) {
		super(pRecord);
	}

	public void fillData() throws ServiceException {
		stringRecord = (TX_OPERATOR_TRAINING) ServiceLocator.getVO(TX_OPERATOR_TRAINING.class);
	 ...
	 * @return
	 */
	public TX_OPERATOR_TRAINING getStringRecord() {
		return stringRecord;
	}
