 ...
 * Ventana&gt;Preferencias&gt;Java&gt;Generación de código&gt;Código y comentarios
 */
public class SodDiscountTrama extends DiscountString {

	private TX_DISCOUNT stringRecord;
	 ...
	 * @param arg1
	 */
	public SodDiscountTrama(String pRecord) {
		super(pRecord);
	}

	public void fillData() throws ServiceException {
		stringRecord = (TX_DISCOUNT) ServiceLocator.getVO(TX_DISCOUNT.class);
	 ...
	 * @return
	 */
	public TX_DISCOUNT getStringRecord() {
		return stringRecord;
	}
