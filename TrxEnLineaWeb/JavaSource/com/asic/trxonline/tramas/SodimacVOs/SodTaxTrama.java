 ...
 * Ventana&gt;Preferencias&gt;Java&gt;Generación de código&gt;Código y comentarios
 */
public class SodTaxTrama extends TaxString {

	private TX_TAX stringRecord;

	public SodTaxTrama(String pRecord) {
		super(pRecord);
	}

	public void fillData() throws ServiceException {
		stringRecord = (TX_TAX) ServiceLocator.getVO(TX_TAX.class);
