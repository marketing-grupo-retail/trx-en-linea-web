 ...
 * Ventana&gt;Preferencias&gt;Java&gt;Generación de código&gt;Código y comentarios
 */
public class SodItemRecordChargeTrama extends ItemRecordChargeString {

	private TX_ITEM_RECORD_CHANGE stringRecord;

	public SodItemRecordChargeTrama(String pRecord) {
		super(pRecord);
	}

	public void fillData() throws ServiceException {
		stringRecord = (TX_ITEM_RECORD_CHANGE) ServiceLocator.getVO(TX_ITEM_RECORD_CHANGE.class);
	 ...
	 * @return
	 */
	public TX_ITEM_RECORD_CHANGE getStringRecord() {
		return stringRecord;
	}
