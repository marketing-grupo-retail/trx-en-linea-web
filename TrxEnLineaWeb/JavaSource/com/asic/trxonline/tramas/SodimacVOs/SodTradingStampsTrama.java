 ...
 * Ventana&gt;Preferencias&gt;Java&gt;Generación de código&gt;Código y comentarios
 */
public class SodTradingStampsTrama extends TradingStampsString {

	private TX_TRADING_STAMPS stringRecord;
	
	public SodTradingStampsTrama(String pRecord) {
		super(pRecord);
	}

	public void fillData() throws ServiceException {
			stringRecord = (TX_TRADING_STAMPS) ServiceLocator.getVO(TX_TRADING_STAMPS.class);
	 ...
	 * @return
	 */
	public TX_TRADING_STAMPS getStringRecord() {
		return stringRecord;
	}
