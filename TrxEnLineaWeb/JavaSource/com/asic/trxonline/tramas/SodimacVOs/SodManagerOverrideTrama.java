 ...
 * Ventana&gt;Preferencias&gt;Java&gt;Generación de código&gt;Código y comentarios
 */
public class SodManagerOverrideTrama extends ManagerOverrideString {
	
	private TX_MANAGER_OVERRIDE stringRecord;

	public SodManagerOverrideTrama(String pRecord) {
		super(pRecord);
	}

	public void fillData() throws ServiceException {
		stringRecord = (TX_MANAGER_OVERRIDE) ServiceLocator.getVO(TX_MANAGER_OVERRIDE.class);
	 ...
	 * @return
	 */
	public TX_MANAGER_OVERRIDE getStringRecord() {
		return stringRecord;
	}
