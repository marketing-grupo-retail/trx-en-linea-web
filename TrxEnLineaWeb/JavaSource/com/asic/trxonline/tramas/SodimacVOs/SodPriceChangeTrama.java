 ...
 * Ventana&gt;Preferencias&gt;Java&gt;Generación de código&gt;Código y comentarios
 */
public class SodPriceChangeTrama extends PriceChangeString{

	private TX_PRICE_CHANGE stringRecord;

	public SodPriceChangeTrama(String pRecord) {
		super(pRecord);
	}

	public void fillData() throws ServiceException {
		stringRecord = (TX_PRICE_CHANGE) ServiceLocator.getVO(TX_PRICE_CHANGE.class);
	 ...
	 * @return
	 */
	public TX_PRICE_CHANGE getStringRecord() {
		return stringRecord;
	}
