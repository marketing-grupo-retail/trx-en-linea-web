 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class MQAdminBeanTest extends TestCase {

	/**
	 * Constructor for MQAdminBeanTest.
	 * @param arg0
	 */
	public MQAdminBeanTest(String arg0) {
		super(arg0);
	}
	...
	public void testEnviarACola() {
		try {
			...
			for (int i = 0; i < 120; i++) {
				...
				td_.setAMTTNFEE("12");
				td_.setCUSTOMER("123456789012345678901234");
				td_.setSTATUS("12");
				td_.setTIPO("X");
				...
				pc_.setOFFSETX(""+i); //falta OFFSETY y OFFSEYX
				...
				irc_.setTIME("12345");
				irc_.setOLDDATA(
					"qwertyuioplkjhgfdsazxcvbnmlkjhgfdsaqwertyuioplkjhgfdsazxcbv");
				irc_.setNEWDATA(
					"qwertyuioplkjhgfdsazxcvbnmlkjhgfdsaqwertyuioplkjhgfdsazxcbv");
				irc_.setTIPO("X");
				...
				tdTEST_.setCUSTOMER("627180800137140500001234");
