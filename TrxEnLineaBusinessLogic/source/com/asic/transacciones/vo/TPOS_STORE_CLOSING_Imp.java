...
/**
 * Clase que permite acceso a la tabla TPOS_STORE_CLOSING y a sus atributos.
 * 
 * @author: null.
 * @version: null
 */
...
public class TPOS_STORE_CLOSING_Imp extends jdao.data.DataAdv implements TPOS_STORE_CLOSING, Serializable {


	/**
	 * Atributo que contiene el nombre de la tabla <B>TPOS_STORE_CLOSING</B>
	 */
	public static final String NAME = "TPOS_STORE_CLOSING";
	/**
	 * Atributo que contiene el nombre del campo <B>OFFSETY</B>
	 * de la tabla <B>TPOS_STORE_CLOSING</B>
	 */
	...
	private java.sql.Timestamp _TFECHAHORA;
	...
	public static final String TFECHAHORA = "TFECHAHORA";
	 ...
	 */
	public TPOS_STORE_CLOSING_Imp() {
		super();
		start();
	}

	/**
	 * Crea un nuevo TPOS_STORE_CLOSING con los campos de la tabla
	...
	public java.sql.Timestamp getTFECHAHORA(){
			return _DAY;
	}

	public void setTFECHAHORA(java.sql.Timestamp newDAY) {
		_TFECHAHORA = newDAY;
	}

	/**
	 * Retorna el nombre de la tabla TPOS_STORE_CLOSING
	...
	/**
	 * Inicia la configuracion de la tabla TPOS_STORE_CLOSING
	 */
	public void start() {
		String _fields[] = {OFFSETY,OFFSETX,STORE,TERMINAL,TRANSNUM,DAY,TIME,INDICAT2,FECHAHORA,TIPO,TFECHAHORA};
		fields = _fields;
		String _keyFields[] = {"STORE","TFECHAHORA"};   //,"TIME"};
	...
	public Object getValueField(String field) { 
		if (field.equals(OFFSETY)) {
			...
			return _TIPO;
		}else if (field.equals(TFECHAHORA)) {
			return _TFECHAHORA;
		}
		return null;
	}
	...
	public void setValueField(String field, Object value) { 
	  if(value!=null){
		if (field.equals(OFFSETY)) {
			...
			setTFECHAHORA((java.sql.Timestamp) value );
		}
	  }
