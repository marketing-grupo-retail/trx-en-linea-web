...
/**
 * Clase que permite acceso a la tabla TX_ITEM_RECORD_CHANGE y a sus atributos.
 * 
 * @author: null.
 * @version: null
 */
...
public class TX_ITEM_RECORD_CHANGE_Imp extends jdao.data.DataAdv implements TX_ITEM_RECORD_CHANGE, Serializable {


	/**
	 * Atributo que contiene el nombre de la tabla <B>TX_ITEM_RECORD_CHANGE</B>
	 */
	public static final String NAME = "TX_ITEM_RECORD_CHANGE";
	/**
	 * Atributo que contiene el nombre del campo <B>OFFSETY</B>
	 * de la tabla <B>TX_ITEM_RECORD_CHANGE</B>
	 */
	 ...
	 */
	public TX_ITEM_RECORD_CHANGE_Imp() {
		super();
		start();
	}

	/**
	 * Crea un nuevo TX_ITEM_RECORD_CHANGE con los campos de la tabla
	 ...
	 */
	public TX_ITEM_RECORD_CHANGE_Imp( java.lang.String pOFFSETY,java.lang.String pOFFSETX,java.lang.String pSTORE,java.lang.String pTERMINAL,java.lang.String pTRANSNUM,java.lang.String pDAY,java.lang.String pTIME,java.lang.String pOLDDATA,java.lang.String pNEWDATA,java.lang.String pTIPO,java.lang.Double pID_RECHAZO) { 
	...
	/**
	 * Retorna el nombre de la tabla TX_ITEM_RECORD_CHANGE
	...
	/**
	 * Inicia la configuracion de la tabla TX_ITEM_RECORD_CHANGE
	 */
	public void start() {
		String _fields[] = {OFFSETY,OFFSETX,STORE,TERMINAL,TRANSNUM,DAY,TIME,OLDDATA,NEWDATA,TIPO,ID_RECHAZO};
		fields = _fields;
		dbProp = false;
	}
	/**
