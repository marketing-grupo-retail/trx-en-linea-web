...
/**
 * Clase que permite acceso a la tabla TPOS_OPERATOR_TRAINING y a sus atributos.
 * 
 * @author: null.
 * @version: null
 */
...
public class TPOS_OPERATOR_TRAINING_Imp extends jdao.data.DataAdv implements TPOS_OPERATOR_TRAINING, Serializable {


	/**
	 * Atributo que contiene el nombre de la tabla <B>TPOS_OPERATOR_TRAINING</B>
	 */
	public static final String NAME = "TPOS_OPERATOR_TRAINING";
	/**
	 * Atributo que contiene el nombre del campo <B>OFFSETY</B>
	 * de la tabla <B>TPOS_OPERATOR_TRAINING</B>
	 */
	 ...
	 */
	public TPOS_OPERATOR_TRAINING_Imp() {
		super();
		start();
	}

	/**
	 * Crea un nuevo TPOS_OPERATOR_TRAINING con los campos de la tabla
	 ...
	 */
	public TPOS_OPERATOR_TRAINING_Imp( java.lang.Double pOFFSETY,java.lang.Double pOFFSETX,java.lang.Double pSTORE,java.lang.Double pTERMINAL,java.lang.Double pTRANSNUM,java.sql.Timestamp pDAY,java.lang.String pTIME,java.lang.String pDATA1,java.lang.String pTIPO, java.sql.Timestamp pFECHAHORA) { 
	...
	/**
	 * Retorna el nombre de la tabla TPOS_OPERATOR_TRAINING
	...
	/**
	 * Inicia la configuracion de la tabla TPOS_OPERATOR_TRAINING
	 */
	public void start() {
		String _fields[] = {OFFSETY,OFFSETX,STORE,TERMINAL,TRANSNUM,DAY,TIME,DATA1,TIPO,FECHAHORA};
		fields = _fields;
		dbProp = false;
	}
	/**
