...
/**
 * Clase que permite acceso a la tabla TPOS_EXCEPTION_LOG y a sus atributos.
 * 
 * @author: null.
 * @version: null
 */
...
public class TPOS_EXCEPTION_LOG_Imp extends jdao.data.DataAdv implements TPOS_EXCEPTION_LOG, Serializable {


	/**
	 * Atributo que contiene el nombre de la tabla <B>TPOS_EXCEPTION_LOG</B>
	 */
	public static final String NAME = "TPOS_EXCEPTION_LOG";
	/**
	 * Atributo que contiene el nombre del campo <B>OFFSETY</B>
	 * de la tabla <B>TPOS_EXCEPTION_LOG</B>
	 */
	...
	/**
	 * Atributo que contiene el nombre del campo <B>LOGDATA</B>
	 * de la tabla <B>TPOS_EXCEPTION_LOG</B>
	 */
	public static final String LOGDATA = "LOGDATA";

	/**
	 * Atributo para manejar el campo <B>LOGDATA</B>
	 * de la tabla <B>LOGDATA</B>
	 */
	private java.lang.String _LOGDATA;
	 ...
	 */
	public TPOS_EXCEPTION_LOG_Imp() {
		super();
		start();
	}

	/**
	 * Crea un nuevo TPOS_EXCEPTION_LOG con los campos de la tabla
	 ...
	 * @param pLOGDATA java.lang.String;
	 * @param pTIPO java.lang.String;
	 */
	public TPOS_EXCEPTION_LOG_Imp( java.lang.Double pOFFSETY,java.lang.Double pOFFSETX,java.lang.Double pSTORE,java.lang.Double pTERMINAL,java.lang.Double pTRANSNUM,java.sql.Timestamp pDAY,java.lang.String pTIME,java.lang.String pLOGDATA,java.lang.String pTIPO, java.sql.Timestamp pFECHAHORA) { 
	...
	/**
	 * Retorna el valor del atributo LOGDATA.
	 * Creation date: (12/15/2005
	 * @return java.lang.String
	 */
	...
	/**
	 * Asigna el atributo LOGDATA
	 * Creation date: (12/15/2005
	 * @param newLOGDATA java.lang.String
	 */
	public void setLOGDATA(java.lang.String newLOGDATA) {
		_LOGDATA = newLOGDATA;
	}
	...
	/**
	 * Retorna el nombre de la tabla TPOS_EXCEPTION_LOG
	...
	/**
	 * Inicia la configuracion de la tabla TPOS_EXCEPTION_LOG
	 */
	public void start() {
		String _fields[] = {OFFSETY,OFFSETX,STORE,TERMINAL,TRANSNUM,DAY,TIME,LOGDATA,TIPO,FECHAHORA};
		fields = _fields;
		dbProp = false;
	}
	/**
	...
	public void setValueField(String field, Object value) { 
	  if(value!=null){
		if (field.equals(OFFSETY)) {
			...
			setLOGDATA((java.lang.String) value );
		} else if (field.equals(TIPO)) {
