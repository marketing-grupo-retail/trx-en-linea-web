...
/**
 * Clase que permite acceso a la tabla TX_OPERATOR_TRAINING y a sus atributos.
 * 
 * @author: null.
 * @version: null
 */
...
public class TX_OPERATOR_TRAINING_Imp extends jdao.data.DataAdv implements TX_OPERATOR_TRAINING, Serializable {


	/**
	 * Atributo que contiene el nombre de la tabla <B>TX_OPERATOR_TRAINING</B>
	 */
	public static final String NAME = "TX_OPERATOR_TRAINING";
	/**
	 * Atributo que contiene el nombre del campo <B>OFFSETY</B>
	 * de la tabla <B>TX_OPERATOR_TRAINING</B>
	 */
	 ...
	 */
	public TX_OPERATOR_TRAINING_Imp() {
		super();
		start();
	}

	/**
	 * Crea un nuevo TX_OPERATOR_TRAINING con los campos de la tabla
	 ...
	 */
	public TX_OPERATOR_TRAINING_Imp( java.lang.String pOFFSETY,java.lang.String pOFFSETX,java.lang.String pSTORE,java.lang.String pTERMINAL,java.lang.String pTRANSNUM,java.lang.String pDAY,java.lang.String pTIME,java.lang.String pDATA1,java.lang.String pTIPO,java.lang.Double pID_RECHAZO) { 
	...
	/**
	 * Retorna el nombre de la tabla TX_OPERATOR_TRAINING
	...
	/**
	 * Inicia la configuracion de la tabla TX_OPERATOR_TRAINING
	 */
	public void start() {
		String _fields[] = {OFFSETY,OFFSETX,STORE,TERMINAL,TRANSNUM,DAY,TIME,DATA1,TIPO,ID_RECHAZO};
		fields = _fields;
		dbProp = false;
	}
	/**
