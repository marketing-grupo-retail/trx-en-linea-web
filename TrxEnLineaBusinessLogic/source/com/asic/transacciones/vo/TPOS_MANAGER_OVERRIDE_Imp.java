...
/**
 * Clase que permite acceso a la tabla TPOS_MANAGER_OVERRIDE y a sus atributos.
 * 
 * @author: null.
 * @version: null
 */
...
public class TPOS_MANAGER_OVERRIDE_Imp extends jdao.data.DataAdv implements TPOS_MANAGER_OVERRIDE, Serializable {


	/**
	 * Atributo que contiene el nombre de la tabla <B>TPOS_MANAGER_OVERRIDE</B>
	 */
	public static final String NAME = "TPOS_MANAGER_OVERRIDE";
	/**
	 * Atributo que contiene el nombre del campo <B>OFFSETY</B>
	 * de la tabla <B>TPOS_MANAGER_OVERRIDE</B>
	 */
	...
	/**
	 * Atributo que contiene el nombre del campo <B>OVERRIDE</B>
	 * de la tabla <B>TPOS_MANAGER_OVERRIDE</B>
	 */
	public static final String OVERRIDE = "OVERRIDE";

	/**
	 * Atributo para manejar el campo <B>OVERRIDE</B>
	 * de la tabla <B>OVERRIDE</B>
	 */
	private java.lang.Double _OVERRIDE;

	/**
	 * Atributo que contiene el nombre del campo <B>REASON</B>
	 * de la tabla <B>TPOS_MANAGER_OVERRIDE</B>
	 */
	public static final String REASON = "REASON";

	/**
	 * Atributo para manejar el campo <B>REASON</B>
	 * de la tabla <B>REASON</B>
	 */
	 ...
	 */
	public TPOS_MANAGER_OVERRIDE_Imp() {
		super();
		start();
	}

	/**
	 * Crea un nuevo TPOS_MANAGER_OVERRIDE con los campos de la tabla
	 ...
	 * @param pOVERRIDE java.lang.Double;
	 * @param pREASON java.lang.String;
	 * @param pTIPO java.lang.String;
	 */
	public TPOS_MANAGER_OVERRIDE_Imp( java.lang.Double pOFFSETY,java.lang.Double pOFFSETX,java.lang.Double pSTORE,java.lang.Double pTERMINAL,java.lang.Double pTRANSNUM,java.sql.Timestamp pDAY,java.lang.String pTIME,java.lang.Double pOVERRIDE,java.lang.String pREASON,java.lang.String pTIPO, java.sql.Timestamp pFECHAHORA) { 
	...
	/**
	 * Retorna el valor del atributo OVERRIDE.
	 * Creation date: (12/15/2005
	 * @return java.lang.Double
	 */
	public java.lang.Double getOVERRIDE(){
			return _OVERRIDE;
	}

	/**
	 * Asigna el atributo OVERRIDE
	 * Creation date: (12/15/2005
	 * @param newOVERRIDE java.lang.Double
	 */
	public void setOVERRIDE(java.lang.Double newOVERRIDE) {
		_OVERRIDE = newOVERRIDE;
	}

	/**
	 * Retorna el valor del atributo REASON.
	 * Creation date: (12/15/2005
	 * @return java.lang.String
	 */
	...
	/**
	 * Retorna el nombre de la tabla TPOS_MANAGER_OVERRIDE
	...
	/**
	 * Inicia la configuracion de la tabla TPOS_MANAGER_OVERRIDE
	 */
	public void start() {
		String _fields[] = {OFFSETY,OFFSETX,STORE,TERMINAL,TRANSNUM,DAY,TIME,OVERRIDE,REASON,TIPO,FECHAHORA};
		fields = _fields;
		dbProp = false;
	}
	/**
	...
	public void setValueField(String field, Object value) { 
	  if(value!=null){
		if (field.equals(OFFSETY)) {
			...
			setOVERRIDE((java.lang.Double) value );
		} else if (field.equals(REASON)) {
