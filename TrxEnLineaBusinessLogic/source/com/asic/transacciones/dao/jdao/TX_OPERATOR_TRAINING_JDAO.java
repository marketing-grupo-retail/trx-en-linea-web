...
public class TX_OPERATOR_TRAINING_JDAO extends TransactionalDao_JDAO implements TX_OPERATOR_TRAINING_DAO  {
	 ...
	 public int delete(TX_OPERATOR_TRAINING pData) 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   ConnectionPool connPool_=getConnPool(TX_OPERATOR_TRAINING_DAO.class);
	 ...
	 public int insert(TX_OPERATOR_TRAINING pData) 
	   ...
	   *
	   * Integer id_ = (Integer)getNextId(TX_OPERATOR_TRAINING_DAO.class,conn_);
	   * pData.setID(id_);
	   */
	 ...
	 public TX_OPERATOR_TRAINING findByPK(TX_OPERATOR_TRAINING pData) 
	   ...
	   */
	   ...
	   TX_OPERATOR_TRAINING res_;

	   try{
	       res_= (TX_OPERATOR_TRAINING)super.findByPK((DataAdv)pData,conn_);
	   }finally{
	   	connPool_.returnConnection(conn_);
	   }
	 ...
	 public List selectVO() 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   TX_OPERATOR_TRAINING data_= new TX_OPERATOR_TRAINING_Imp();
	   ConnectionPool connPool_=getConnPool(TX_OPERATOR_TRAINING_DAO.class);
	   Connection conn_=connPool_.getConnection();
	 ...
	 public ConnectionPool getPool() 	  throws ConnectionFailedException, DBAccessException {	   return getConnPool(TX_OPERATOR_TRAINING_DAO.class);
	 }
