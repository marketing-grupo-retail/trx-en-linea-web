...
import com.asic.transacciones.dao.TX_DESTINO_EMAIL_DAO;
import com.asic.transacciones.vo.TX_DESTINO_EMAIL;
import com.asic.transacciones.vo.TX_DESTINO_EMAIL_Imp;

//import .TX_DESTINO_EMAIL;

public class TX_DESTINO_EMAIL_JDAO extends TransactionalDao_JDAO implements TX_DESTINO_EMAIL_DAO  {
	 ...
	 public int delete(TX_DESTINO_EMAIL pData) 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   ConnectionPool connPool_=getConnPool(TX_DESTINO_EMAIL_DAO.class);
	 ...
	 public int insert(TX_DESTINO_EMAIL pData) 
	   ...
	   *
	   * Integer id_ = (Integer)getNextId(TX_DESTINO_EMAIL_DAO.class,conn_);
	   * pData.setID(id_);
	   */
	 ...
	 public TX_DESTINO_EMAIL findByPK(TX_DESTINO_EMAIL pData) 
	   ...
	   */
	   ...
	   TX_DESTINO_EMAIL res_;

	   try{
	       res_= (TX_DESTINO_EMAIL)super.findByPK((DataAdv)pData,conn_);
	   }finally{
	   	connPool_.returnConnection(conn_);
	   }
	 ...
	 public List selectVO() 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   TX_DESTINO_EMAIL data_= new TX_DESTINO_EMAIL_Imp();
	   ConnectionPool connPool_=getConnPool(TX_DESTINO_EMAIL_DAO.class);
	   Connection conn_=connPool_.getConnection();
	 ...
	 public ConnectionPool getPool() 	  throws ConnectionFailedException, DBAccessException {	   return getConnPool(TX_DESTINO_EMAIL_DAO.class);
	 }
