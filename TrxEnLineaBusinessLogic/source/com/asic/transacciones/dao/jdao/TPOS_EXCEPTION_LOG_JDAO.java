...
public class TPOS_EXCEPTION_LOG_JDAO extends TransactionalDao_JDAO implements TPOS_EXCEPTION_LOG_DAO  {
	 ...
	 public int delete(TPOS_EXCEPTION_LOG pData) 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   ConnectionPool connPool_=getConnPool(TPOS_EXCEPTION_LOG_DAO.class);
	 ...
	 public int insert(TPOS_EXCEPTION_LOG pData) 
	   ...
	   *
	   * Integer id_ = (Integer)getNextId(TPOS_EXCEPTION_LOG_DAO.class,conn_);
	   * pData.setID(id_);
	   */
	 ...
	 public TPOS_EXCEPTION_LOG findByPK(TPOS_EXCEPTION_LOG pData) 
	   ...
	   */
	   ...
	   TPOS_EXCEPTION_LOG res_;

	   try{
	       res_= (TPOS_EXCEPTION_LOG)super.findByPK((DataAdv)pData,conn_);
	   }finally{
	   	connPool_.returnConnection(conn_);
	   }
	 ...
	 public List selectVO() 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   TPOS_EXCEPTION_LOG data_= new TPOS_EXCEPTION_LOG_Imp();
	   ConnectionPool connPool_=getConnPool(TPOS_EXCEPTION_LOG_DAO.class);
	   Connection conn_=connPool_.getConnection();
	 ...
	 public ConnectionPool getPool() 	  throws ConnectionFailedException, DBAccessException {	   return getConnPool(TPOS_EXCEPTION_LOG_DAO.class);
	 }
