...
public class TX_TRADING_STAMPS_JDAO extends TransactionalDao_JDAO implements TX_TRADING_STAMPS_DAO  {
	 ...
	 public int delete(TX_TRADING_STAMPS pData) 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   ConnectionPool connPool_=getConnPool(TX_TRADING_STAMPS_DAO.class);
	 ...
	 public int insert(TX_TRADING_STAMPS pData) 
	   ...
	   *
	   * Integer id_ = (Integer)getNextId(TX_TRADING_STAMPS_DAO.class,conn_);
	   * pData.setID(id_);
	   */
	 ...
	 public TX_TRADING_STAMPS findByPK(TX_TRADING_STAMPS pData) 
	   ...
	   */
	   ...
	   TX_TRADING_STAMPS res_;

	   try{
	       res_= (TX_TRADING_STAMPS)super.findByPK((DataAdv)pData,conn_);
	   }finally{
	   	connPool_.returnConnection(conn_);
	   }
	 ...
	 public List selectVO() 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   TX_TRADING_STAMPS data_= new TX_TRADING_STAMPS_Imp();
	   ConnectionPool connPool_=getConnPool(TX_TRADING_STAMPS_DAO.class);
	   Connection conn_=connPool_.getConnection();
	 ...
	 public ConnectionPool getPool() 	  throws ConnectionFailedException, DBAccessException {	   return getConnPool(TX_TRADING_STAMPS_DAO.class);
	 }
