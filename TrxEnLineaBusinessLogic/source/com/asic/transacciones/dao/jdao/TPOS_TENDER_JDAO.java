...
public class TPOS_TENDER_JDAO extends TransactionalDao_JDAO implements TPOS_TENDER_DAO  {
	 ...
	 public int delete(TPOS_TENDER pData) 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   ConnectionPool connPool_=getConnPool(TPOS_TENDER_DAO.class);
	 ...
	 public int insert(TPOS_TENDER pData) 
	   ...
	   *
	   * Integer id_ = (Integer)getNextId(TPOS_TENDER_DAO.class,conn_);
	   * pData.setID(id_);
	   */
	 ...
	 public TPOS_TENDER findByPK(TPOS_TENDER pData) 
	   ...
	   */
	   ...
	   try{
	       res_= (TPOS_TENDER)super.findByPK((DataAdv)pData,conn_);
	   }finally{
	   	connPool_.returnConnection(conn_);
	   }
	 ...
	 public List selectVO() 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   TPOS_TENDER data_= new TPOS_TENDER_Imp();
	   ConnectionPool connPool_=getConnPool(TPOS_TENDER_DAO.class);
	   Connection conn_=connPool_.getConnection();
	 ...
	 public ConnectionPool getPool() 	  throws ConnectionFailedException, DBAccessException {	   return getConnPool(TPOS_TENDER_DAO.class);
	 }
