...
public class TX_DATA_ENTRY_JDAO extends TransactionalDao_JDAO implements TX_DATA_ENTRY_DAO  {
	 ...
	 public int delete(TX_DATA_ENTRY pData) 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   ConnectionPool connPool_=getConnPool(TX_DATA_ENTRY_DAO.class);
	 ...
	 public int insert(TX_DATA_ENTRY pData) 
	   ...
	   *
	   * Integer id_ = (Integer)getNextId(TX_DATA_ENTRY_DAO.class,conn_);
	   * pData.setID(id_);
	   */
	 ...
	 public TX_DATA_ENTRY findByPK(TX_DATA_ENTRY pData) 
	   ...
	   */
	   ...
	   try{
	       res_= (TX_DATA_ENTRY)super.findByPK((DataAdv)pData,conn_);
	   }finally{
	   	connPool_.returnConnection(conn_);
	   }
	 ...
	 public List selectVO() 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   TX_DATA_ENTRY data_= new TX_DATA_ENTRY_Imp();
	   ConnectionPool connPool_=getConnPool(TX_DATA_ENTRY_DAO.class);
	   Connection conn_=connPool_.getConnection();
	 ...
	 public ConnectionPool getPool() 	  throws ConnectionFailedException, DBAccessException {	   return getConnPool(TX_DATA_ENTRY_DAO.class);
	 }
