...
public class TX_HEADER_JDAO extends TransactionalDao_JDAO implements TX_HEADER_DAO  {
	 ...
	 public int delete(TX_HEADER pData) 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   ConnectionPool connPool_=getConnPool(TX_HEADER_DAO.class);
	 ...
	 public int insert(TX_HEADER pData) 
	   ...
	   *
	   * Integer id_ = (Integer)getNextId(TX_HEADER_DAO.class,conn_);
	   * pData.setID(id_);
	   */
	 ...
	 public TX_HEADER findByPK(TX_HEADER pData) 
	   ...
	   */
	   ...
	   try{
	       res_= (TX_HEADER)super.findByPK((DataAdv)pData,conn_);
	   }finally{
	   	connPool_.returnConnection(conn_);
	   }
	 ...
	 public List selectVO() 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   TX_HEADER data_= new TX_HEADER_Imp();
	   ConnectionPool connPool_=getConnPool(TX_HEADER_DAO.class);
	   Connection conn_=connPool_.getConnection();
	 ...
	 public ConnectionPool getPool() 	  throws ConnectionFailedException, DBAccessException {	   return getConnPool(TX_HEADER_DAO.class);
	 }
