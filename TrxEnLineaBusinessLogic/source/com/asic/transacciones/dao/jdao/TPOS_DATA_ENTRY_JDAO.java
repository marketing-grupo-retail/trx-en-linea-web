...
public class TPOS_DATA_ENTRY_JDAO extends TransactionalDao_JDAO implements TPOS_DATA_ENTRY_DAO  {
	 ...
	 public int delete(TPOS_DATA_ENTRY pData) 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   ConnectionPool connPool_=getConnPool(TPOS_DATA_ENTRY_DAO.class);
	 ...
	 public int insert(TPOS_DATA_ENTRY pData) 
	   ...
	   *
	   * Integer id_ = (Integer)getNextId(TPOS_DATA_ENTRY_DAO.class,conn_);
	   * pData.setID(id_);
	   */
	 ...
	 public TPOS_DATA_ENTRY findByPK(TPOS_DATA_ENTRY pData) 
	   ...
	   */
	   ...
	   TPOS_DATA_ENTRY res_;

	   try{
	       res_= (TPOS_DATA_ENTRY)super.findByPK((DataAdv)pData,conn_);
	   }finally{
	   	connPool_.returnConnection(conn_);
	   }
	 ...
	 public List selectVO() 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   TPOS_DATA_ENTRY data_= new TPOS_DATA_ENTRY_Imp();
	   ConnectionPool connPool_=getConnPool(TPOS_DATA_ENTRY_DAO.class);
	   Connection conn_=connPool_.getConnection();
	 ...
	 public ConnectionPool getPool() 	  throws ConnectionFailedException, DBAccessException {	   return getConnPool(TPOS_DATA_ENTRY_DAO.class);
	 }
