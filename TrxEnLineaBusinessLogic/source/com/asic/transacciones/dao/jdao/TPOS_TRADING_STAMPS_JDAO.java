...
public class TPOS_TRADING_STAMPS_JDAO extends TransactionalDao_JDAO implements TPOS_TRADING_STAMPS_DAO  {
	 ...
	 public int delete(TPOS_TRADING_STAMPS pData) 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   ConnectionPool connPool_=getConnPool(TPOS_TRADING_STAMPS_DAO.class);
	 ...
	 public int insert(TPOS_TRADING_STAMPS pData) 
	   ...
	   *
	   * Integer id_ = (Integer)getNextId(TPOS_TRADING_STAMPS_DAO.class,conn_);
	   * pData.setID(id_);
	   */
	 ...
	 public TPOS_TRADING_STAMPS findByPK(TPOS_TRADING_STAMPS pData) 
	   ...
	   */
	   ...
	   TPOS_TRADING_STAMPS res_;

	   try{
	       res_= (TPOS_TRADING_STAMPS)super.findByPK((DataAdv)pData,conn_);
	   }finally{
	   	connPool_.returnConnection(conn_);
	   }
	 ...
	 public List selectVO() 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   TPOS_TRADING_STAMPS data_= new TPOS_TRADING_STAMPS_Imp();
	   ConnectionPool connPool_=getConnPool(TPOS_TRADING_STAMPS_DAO.class);
	   Connection conn_=connPool_.getConnection();
	 ...
	 public ConnectionPool getPool() 	  throws ConnectionFailedException, DBAccessException {	   return getConnPool(TPOS_TRADING_STAMPS_DAO.class);
	 }
