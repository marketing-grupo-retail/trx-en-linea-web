...
public class TX_ITEMENTRY_JDAO extends TransactionalDao_JDAO implements TX_ITEMENTRY_DAO  {
	 ...
	 public int delete(TX_ITEMENTRY pData) 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   ConnectionPool connPool_=getConnPool(TX_ITEMENTRY_DAO.class);
	 ...
	 public int insert(TX_ITEMENTRY pData) 
	   ...
	   *
	   * Integer id_ = (Integer)getNextId(TX_ITEMENTRY_DAO.class,conn_);
	   * pData.setID(id_);
	   */
	 ...
	 public TX_ITEMENTRY findByPK(TX_ITEMENTRY pData) 
	   ...
	   */
	   ...
	   try{
	       res_= (TX_ITEMENTRY)super.findByPK((DataAdv)pData,conn_);
	   }finally{
	   	connPool_.returnConnection(conn_);
	   }
	 ...
	 public List selectVO() 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   TX_ITEMENTRY data_= new TX_ITEMENTRY_Imp();
	   ConnectionPool connPool_=getConnPool(TX_ITEMENTRY_DAO.class);
	   Connection conn_=connPool_.getConnection();
	 ...
	 public ConnectionPool getPool() 	  throws ConnectionFailedException, DBAccessException {	   return getConnPool(TX_ITEMENTRY_DAO.class);
	 }
