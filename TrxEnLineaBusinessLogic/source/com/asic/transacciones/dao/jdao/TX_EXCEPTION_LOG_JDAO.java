...
//import .TX_EXCEPTION_LOG;

public class TX_EXCEPTION_LOG_JDAO extends TransactionalDao_JDAO implements TX_EXCEPTION_LOG_DAO  {

	 public int delete(TX_EXCEPTION_LOG pData) 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   ConnectionPool connPool_=getConnPool(TX_EXCEPTION_LOG_DAO.class);
	 ...
	 public int insert(TX_EXCEPTION_LOG pData) 
	  throws ConnectionFailedException, DBAccessException{
	   ...
	   *
	   * Integer id_ = (Integer)getNextId(TX_EXCEPTION_LOG_DAO.class,conn_);
	   * pData.setID(id_);
	   */
	 ...
	 public Integer insertByPK(TX_EXCEPTION_LOG pData) 
	  throws ConnectionFailedException, DBAccessException{
	 ...
	 public TX_EXCEPTION_LOG findByPK(TX_EXCEPTION_LOG pData) 
	  throws ConnectionFailedException, DBAccessException{
	   ...
	   */
	   ...
	   TX_EXCEPTION_LOG res_;

	   try{
	       res_= (TX_EXCEPTION_LOG)super.findByPK((DataAdv)pData,conn_);
	   }finally{
	   	connPool_.returnConnection(conn_);
	   }
	 ...
	 public List selectVO() 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   TX_EXCEPTION_LOG data_= new TX_EXCEPTION_LOG_Imp();
	   ConnectionPool connPool_=getConnPool(TX_EXCEPTION_LOG_DAO.class);
	   Connection conn_=connPool_.getConnection();
	 ...
	 public List selectVO(TX_EXCEPTION_LOG pData) 
	  throws ConnectionFailedException, DBAccessException{
	 ...
	 public List selectVOFiltred(TX_EXCEPTION_LOG pData,String pTable,String pFilter) 
	  throws ConnectionFailedException, DBAccessException{
	 ...
	 public List selectVOFiltred(TX_EXCEPTION_LOG pData,String pFields,String pTable,String pFilter) 
	  throws ConnectionFailedException, DBAccessException{
	 ...
	 public int update(TX_EXCEPTION_LOG pData) 
	  throws ConnectionFailedException, DBAccessException{
	 ...
	 public int update(TX_EXCEPTION_LOG pData,String pFilter,Object[] params) 
	  throws ConnectionFailedException, DBAccessException{
	 ...
	 public ConnectionPool getPool() 	  throws ConnectionFailedException, DBAccessException {	   return getConnPool(TX_EXCEPTION_LOG_DAO.class);
	 }

	 public int insert(TX_EXCEPTION_LOG pData, boolean isTransaction) 
	  throws ConnectionFailedException, DBAccessException{
	 ...
	 public Integer insertByPK(TX_EXCEPTION_LOG pData, boolean isTransaction) 
	  throws ConnectionFailedException, DBAccessException{
	 ...
	 public int delete(TX_EXCEPTION_LOG pData, boolean isTransaction) 
	  throws ConnectionFailedException, DBAccessException{
	 ...
	 public int update(TX_EXCEPTION_LOG pData, boolean isTransaction) 
	  throws ConnectionFailedException, DBAccessException{
	 ...
	 public int update(TX_EXCEPTION_LOG pData,String pFilter,Object[] params, boolean isTransaction) 
	  throws ConnectionFailedException, DBAccessException{
