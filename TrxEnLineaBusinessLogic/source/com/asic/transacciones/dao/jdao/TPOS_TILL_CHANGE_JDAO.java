...
public class TPOS_TILL_CHANGE_JDAO extends TransactionalDao_JDAO implements TPOS_TILL_CHANGE_DAO  {
	 ...
	 public int delete(TPOS_TILL_CHANGE pData) 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   ConnectionPool connPool_=getConnPool(TPOS_TILL_CHANGE_DAO.class);
	 ...
	 public int insert(TPOS_TILL_CHANGE pData) 
	   ...
	   *
	   * Integer id_ = (Integer)getNextId(TPOS_TILL_CHANGE_DAO.class,conn_);
	   * pData.setID(id_);
	   */
	 ...
	 public TPOS_TILL_CHANGE findByPK(TPOS_TILL_CHANGE pData) 
	   ...
	   */
	   ...
	   TPOS_TILL_CHANGE res_;

	   try{
	       res_= (TPOS_TILL_CHANGE)super.findByPK((DataAdv)pData,conn_);
	   }finally{
	   	connPool_.returnConnection(conn_);
	   }
	 ...
	 public List selectVO() 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   TPOS_TILL_CHANGE data_= new TPOS_TILL_CHANGE_Imp();
	   ConnectionPool connPool_=getConnPool(TPOS_TILL_CHANGE_DAO.class);
	   Connection conn_=connPool_.getConnection();
	 ...
	 public ConnectionPool getPool() 	  throws ConnectionFailedException, DBAccessException {	   return getConnPool(TPOS_TILL_CHANGE_DAO.class);
	 }
