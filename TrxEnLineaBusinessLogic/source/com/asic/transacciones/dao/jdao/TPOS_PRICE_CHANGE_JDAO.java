...
public class TPOS_PRICE_CHANGE_JDAO extends TransactionalDao_JDAO implements TPOS_PRICE_CHANGE_DAO  {
	 ...
	 public int delete(TPOS_PRICE_CHANGE pData) 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   ConnectionPool connPool_=getConnPool(TPOS_PRICE_CHANGE_DAO.class);
	 ...
	 public int insert(TPOS_PRICE_CHANGE pData) 
	   ...
	   *
	   * Integer id_ = (Integer)getNextId(TPOS_PRICE_CHANGE_DAO.class,conn_);
	   * pData.setID(id_);
	   */
	 ...
	 public TPOS_PRICE_CHANGE findByPK(TPOS_PRICE_CHANGE pData) 
	   ...
	   */
	   ...
	   TPOS_PRICE_CHANGE res_;

	   try{
	       res_= (TPOS_PRICE_CHANGE)super.findByPK((DataAdv)pData,conn_);
	   }finally{
	   	connPool_.returnConnection(conn_);
	   }
	 ...
	 public List selectVO() 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   TPOS_PRICE_CHANGE data_= new TPOS_PRICE_CHANGE_Imp();
	   ConnectionPool connPool_=getConnPool(TPOS_PRICE_CHANGE_DAO.class);
	   Connection conn_=connPool_.getConnection();
	 ...
	 public ConnectionPool getPool() 	  throws ConnectionFailedException, DBAccessException {	   return getConnPool(TPOS_PRICE_CHANGE_DAO.class);
	 }
