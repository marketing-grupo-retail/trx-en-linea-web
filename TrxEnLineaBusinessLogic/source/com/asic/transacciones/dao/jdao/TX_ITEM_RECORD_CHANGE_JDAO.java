...
public class TX_ITEM_RECORD_CHANGE_JDAO extends TransactionalDao_JDAO implements TX_ITEM_RECORD_CHANGE_DAO  {
	 ...
	 public int delete(TX_ITEM_RECORD_CHANGE pData) 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   ConnectionPool connPool_=getConnPool(TX_ITEM_RECORD_CHANGE_DAO.class);
	 ...
	 public int insert(TX_ITEM_RECORD_CHANGE pData) 
	   ...
	   *
	   * Integer id_ = (Integer)getNextId(TX_ITEM_RECORD_CHANGE_DAO.class,conn_);
	   * pData.setID(id_);
	   */
	 ...
	 public TX_ITEM_RECORD_CHANGE findByPK(TX_ITEM_RECORD_CHANGE pData) 
	   ...
	   */
	   ...
	   TX_ITEM_RECORD_CHANGE res_;

	   try{
	       res_= (TX_ITEM_RECORD_CHANGE)super.findByPK((DataAdv)pData,conn_);
	   }finally{
	   	connPool_.returnConnection(conn_);
	   }
	 ...
	 public List selectVO() 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   TX_ITEM_RECORD_CHANGE data_= new TX_ITEM_RECORD_CHANGE_Imp();
	   ConnectionPool connPool_=getConnPool(TX_ITEM_RECORD_CHANGE_DAO.class);
	   Connection conn_=connPool_.getConnection();
	 ...
	 public ConnectionPool getPool() 	  throws ConnectionFailedException, DBAccessException {	   return getConnPool(TX_ITEM_RECORD_CHANGE_DAO.class);
	 }
