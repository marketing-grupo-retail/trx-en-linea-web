...
public class TPOS_TENDER2_JDAO extends TransactionalDao_JDAO implements TPOS_TENDER2_DAO  {
	 ...
	 public int delete(TPOS_TENDER2 pData) 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   ConnectionPool connPool_=getConnPool(TPOS_TENDER2_DAO.class);
	 ...
	 public int insert(TPOS_TENDER2 pData) 
	   ...
	   *
	   * Integer id_ = (Integer)getNextId(TPOS_TENDER2_DAO.class,conn_);
	   * pData.setID(id_);
	   */
	 ...
	 public TPOS_TENDER2 findByPK(TPOS_TENDER2 pData) 
	   ...
	   */
	   ...
	   try{
	       res_= (TPOS_TENDER2)super.findByPK((DataAdv)pData,conn_);
	   }finally{
	   	connPool_.returnConnection(conn_);
	   }
	 ...
	 public List selectVO() 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   TPOS_TENDER2 data_= new TPOS_TENDER2_Imp();
	   ConnectionPool connPool_=getConnPool(TPOS_TENDER2_DAO.class);
	   Connection conn_=connPool_.getConnection();
	 ...
	 public ConnectionPool getPool() 	  throws ConnectionFailedException, DBAccessException {	   return getConnPool(TPOS_TENDER2_DAO.class);
	 }
