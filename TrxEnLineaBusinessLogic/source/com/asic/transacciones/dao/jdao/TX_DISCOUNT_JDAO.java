...
public class TX_DISCOUNT_JDAO extends TransactionalDao_JDAO implements TX_DISCOUNT_DAO  {
	 ...
	 public int delete(TX_DISCOUNT pData) 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   ConnectionPool connPool_=getConnPool(TX_DISCOUNT_DAO.class);
	 ...
	 public int insert(TX_DISCOUNT pData) 
	   ...
	   *
	   * Integer id_ = (Integer)getNextId(TX_DISCOUNT_DAO.class,conn_);
	   * pData.setID(id_);
	   */
	 ...
	 public TX_DISCOUNT findByPK(TX_DISCOUNT pData) 
	   ...
	   */
	   ...
	   try{
	       res_= (TX_DISCOUNT)super.findByPK((DataAdv)pData,conn_);
	   }finally{
	   	connPool_.returnConnection(conn_);
	   }
	 ...
	 public List selectVO() 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   TX_DISCOUNT data_= new TX_DISCOUNT_Imp();
	   ConnectionPool connPool_=getConnPool(TX_DISCOUNT_DAO.class);
	   Connection conn_=connPool_.getConnection();
	 ...
	 public ConnectionPool getPool() 	  throws ConnectionFailedException, DBAccessException {	   return getConnPool(TX_DISCOUNT_DAO.class);
	 }
