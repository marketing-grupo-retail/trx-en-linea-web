...
public class TPOS_ITEM_RECORD_CHANGE_JDAO extends TransactionalDao_JDAO implements TPOS_ITEM_RECORD_CHANGE_DAO  {
	 ...
	 public int delete(TPOS_ITEM_RECORD_CHANGE pData) 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   ConnectionPool connPool_=getConnPool(TPOS_ITEM_RECORD_CHANGE_DAO.class);
	 ...
	 public int insert(TPOS_ITEM_RECORD_CHANGE pData) 
	   ...
	   *
	   * Integer id_ = (Integer)getNextId(TPOS_ITEM_RECORD_CHANGE_DAO.class,conn_);
	   * pData.setID(id_);
	   */
	 ...
	 public TPOS_ITEM_RECORD_CHANGE findByPK(TPOS_ITEM_RECORD_CHANGE pData) 
	   ...
	   */
	   ...
	   TPOS_ITEM_RECORD_CHANGE res_;

	   try{
	       res_= (TPOS_ITEM_RECORD_CHANGE)super.findByPK((DataAdv)pData,conn_);
	   }finally{
	   	connPool_.returnConnection(conn_);
	   }
	 ...
	 public List selectVO() 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   TPOS_ITEM_RECORD_CHANGE data_= new TPOS_ITEM_RECORD_CHANGE_Imp();
	   ConnectionPool connPool_=getConnPool(TPOS_ITEM_RECORD_CHANGE_DAO.class);
	   Connection conn_=connPool_.getConnection();
	 ...
	 public ConnectionPool getPool() 	  throws ConnectionFailedException, DBAccessException {	   return getConnPool(TPOS_ITEM_RECORD_CHANGE_DAO.class);
	 }
