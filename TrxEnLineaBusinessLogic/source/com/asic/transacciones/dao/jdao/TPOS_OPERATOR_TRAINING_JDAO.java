...
public class TPOS_OPERATOR_TRAINING_JDAO extends TransactionalDao_JDAO implements TPOS_OPERATOR_TRAINING_DAO  {
	 ...
	 public int delete(TPOS_OPERATOR_TRAINING pData) 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   ConnectionPool connPool_=getConnPool(TPOS_OPERATOR_TRAINING_DAO.class);
	 ...
	 public int insert(TPOS_OPERATOR_TRAINING pData) 
	   ...
	   *
	   * Integer id_ = (Integer)getNextId(TPOS_OPERATOR_TRAINING_DAO.class,conn_);
	   * pData.setID(id_);
	   */
	 ...
	 public TPOS_OPERATOR_TRAINING findByPK(TPOS_OPERATOR_TRAINING pData) 
	   ...
	   */
	   ...
	   TPOS_OPERATOR_TRAINING res_;

	   try{
	       res_= (TPOS_OPERATOR_TRAINING)super.findByPK((DataAdv)pData,conn_);
	   }finally{
	   	connPool_.returnConnection(conn_);
	   }
	 ...
	 public List selectVO() 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   TPOS_OPERATOR_TRAINING data_= new TPOS_OPERATOR_TRAINING_Imp();
	   ConnectionPool connPool_=getConnPool(TPOS_OPERATOR_TRAINING_DAO.class);
	   Connection conn_=connPool_.getConnection();
	 ...
	 public ConnectionPool getPool() 	  throws ConnectionFailedException, DBAccessException {	   return getConnPool(TPOS_OPERATOR_TRAINING_DAO.class);
	 }
