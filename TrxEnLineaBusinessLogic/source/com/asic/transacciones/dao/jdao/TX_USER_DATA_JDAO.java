...
public class TX_USER_DATA_JDAO extends TransactionalDao_JDAO implements TX_USER_DATA_DAO  {

	 public int delete(TX_USER_DATA pData) 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   ConnectionPool connPool_=getConnPool(TX_USER_DATA_DAO.class);
	 ...
	 public int insert(TX_USER_DATA pData) 
	  throws ConnectionFailedException, DBAccessException{
	   ...
	   *
	   * Integer id_ = (Integer)getNextId(TX_USER_DATA_DAO.class,conn_);
	   * pData.setID(id_);
	   */
	 ...
	 public Integer insertByPK(TX_USER_DATA pData) 
	  throws ConnectionFailedException, DBAccessException{
	 ...
	 public TX_USER_DATA findByPK(TX_USER_DATA pData) 
	  throws ConnectionFailedException, DBAccessException{
	   ...
	   */
	   ...
	   try{
	       res_= (TX_USER_DATA)super.findByPK((DataAdv)pData,conn_);
	   }finally{
	   	connPool_.returnConnection(conn_);
	   }
	 ...
	 public List selectVO() 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   TX_USER_DATA data_= new TX_USER_DATA_Imp();
	   ConnectionPool connPool_=getConnPool(TX_USER_DATA_DAO.class);
	   Connection conn_=connPool_.getConnection();
	 ...
	 public List selectVO(TX_USER_DATA pData) 
	  throws ConnectionFailedException, DBAccessException{
	 ...
	 public List selectVOFiltred(TX_USER_DATA pData,String pTable,String pFilter) 
	  throws ConnectionFailedException, DBAccessException{
	 ...
	 public List selectVOFiltred(TX_USER_DATA pData,String pFields,String pTable,String pFilter) 
	  throws ConnectionFailedException, DBAccessException{
	 ...
	 public int update(TX_USER_DATA pData) 
	  throws ConnectionFailedException, DBAccessException{
	 ...
	 public int update(TX_USER_DATA pData,String pFilter,Object[] params) 
	  throws ConnectionFailedException, DBAccessException{
	 ...
	 public ConnectionPool getPool() 	  throws ConnectionFailedException, DBAccessException {	   return getConnPool(TX_USER_DATA_DAO.class);
	 }

	 public int insert(TX_USER_DATA pData, boolean isTransaction) 
	  throws ConnectionFailedException, DBAccessException{
	 ...
	 public Integer insertByPK(TX_USER_DATA pData, boolean isTransaction) 
	  throws ConnectionFailedException, DBAccessException{
	 ...
	 public int delete(TX_USER_DATA pData, boolean isTransaction) 
	  throws ConnectionFailedException, DBAccessException{
	 ...
	 public int update(TX_USER_DATA pData, boolean isTransaction) 
	  throws ConnectionFailedException, DBAccessException{
	 ...
	 public int update(TX_USER_DATA pData,String pFilter,Object[] params, boolean isTransaction) 
	  throws ConnectionFailedException, DBAccessException{
