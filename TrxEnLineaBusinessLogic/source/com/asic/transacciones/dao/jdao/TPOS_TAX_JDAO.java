...
public class TPOS_TAX_JDAO extends TransactionalDao_JDAO implements TPOS_TAX_DAO  {
	 ...
	 public int delete(TPOS_TAX pData) 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   ConnectionPool connPool_=getConnPool(TPOS_TAX_DAO.class);
	 ...
	 public int insert(TPOS_TAX pData) 
	   ...
	   *
	   * Integer id_ = (Integer)getNextId(TPOS_TAX_DAO.class,conn_);
	   * pData.setID(id_);
	   */
	 ...
	 public TPOS_TAX findByPK(TPOS_TAX pData) 
	   ...
	   */
	   ...
	   try{
	       res_= (TPOS_TAX)super.findByPK((DataAdv)pData,conn_);
	   }finally{
	   	connPool_.returnConnection(conn_);
	   }
	 ...
	 public List selectVO() 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   TPOS_TAX data_= new TPOS_TAX_Imp();
	   ConnectionPool connPool_=getConnPool(TPOS_TAX_DAO.class);
	   Connection conn_=connPool_.getConnection();
	 ...
	 public ConnectionPool getPool() 	  throws ConnectionFailedException, DBAccessException {	   return getConnPool(TPOS_TAX_DAO.class);
	 }
