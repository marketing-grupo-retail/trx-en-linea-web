...
public class TX_TAX_JDAO extends TransactionalDao_JDAO implements TX_TAX_DAO  {
	 ...
	 public int delete(TX_TAX pData) 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   ConnectionPool connPool_=getConnPool(TX_TAX_DAO.class);
	 ...
	 public int insert(TX_TAX pData) 
	   ...
	   *
	   * Integer id_ = (Integer)getNextId(TX_TAX_DAO.class,conn_);
	   * pData.setID(id_);
	   */
	 ...
	 public TX_TAX findByPK(TX_TAX pData) 
	   ...
	   */
	   ...
	   try{
	       res_= (TX_TAX)super.findByPK((DataAdv)pData,conn_);
	   }finally{
	   	connPool_.returnConnection(conn_);
	   }
	 ...
	 public ConnectionPool getPool() 	  throws ConnectionFailedException, DBAccessException {	   return getConnPool(TX_TAX_DAO.class);
	 }
