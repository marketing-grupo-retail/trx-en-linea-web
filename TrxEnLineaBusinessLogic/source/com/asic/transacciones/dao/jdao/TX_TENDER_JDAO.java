...
public class TX_TENDER_JDAO extends TransactionalDao_JDAO implements TX_TENDER_DAO  {
	 ...
	 public int delete(TX_TENDER pData) 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   ConnectionPool connPool_=getConnPool(TX_TENDER_DAO.class);
	 ...
	 public int insert(TX_TENDER pData) 
	   ...
	   *
	   * Integer id_ = (Integer)getNextId(TX_TENDER_DAO.class,conn_);
	   * pData.setID(id_);
	   */
	 ...
	 public TX_TENDER findByPK(TX_TENDER pData) 
	   ...
	   */
	   ...
	   try{
	       res_= (TX_TENDER)super.findByPK((DataAdv)pData,conn_);
	   }finally{
	   	connPool_.returnConnection(conn_);
	   }
	 ...
	 public List selectVO() 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   TX_TENDER data_= new TX_TENDER_Imp();
	   ConnectionPool connPool_=getConnPool(TX_TENDER_DAO.class);
	   Connection conn_=connPool_.getConnection();
	 ...
	 public ConnectionPool getPool() 	  throws ConnectionFailedException, DBAccessException {	   return getConnPool(TX_TENDER_DAO.class);
	 }
