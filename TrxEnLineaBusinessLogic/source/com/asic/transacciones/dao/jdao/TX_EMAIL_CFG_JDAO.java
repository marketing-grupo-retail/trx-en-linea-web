...
import com.asic.transacciones.dao.TX_EMAIL_CFG_DAO;
import com.asic.transacciones.vo.TX_EMAIL_CFG;
import com.asic.transacciones.vo.TX_EMAIL_CFG_Imp;

//import .TX_EMAIL_CFG;

public class TX_EMAIL_CFG_JDAO extends TransactionalDao_JDAO implements TX_EMAIL_CFG_DAO  {

	 public int delete(TX_EMAIL_CFG pData) 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   ConnectionPool connPool_=getConnPool(TX_EMAIL_CFG_DAO.class);
	 ...
	 public int insert(TX_EMAIL_CFG pData) 
	  throws ConnectionFailedException, DBAccessException{
	   ...
	   *
	   * Integer id_ = (Integer)getNextId(TX_EMAIL_CFG_DAO.class,conn_);
	   * pData.setID(id_);
	   */
	 ...
	 public Integer insertByPK(TX_EMAIL_CFG pData) 
	  throws ConnectionFailedException, DBAccessException{
	 ...
	 public TX_EMAIL_CFG findByPK(TX_EMAIL_CFG pData) 
	  throws ConnectionFailedException, DBAccessException{
	   ...
	   */
	   ...
	   try{
	       res_= (TX_EMAIL_CFG)super.findByPK((DataAdv)pData,conn_);
	   }finally{
	   	connPool_.returnConnection(conn_);
	   }
	 ...
	 public List selectVO() 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   TX_EMAIL_CFG data_= new TX_EMAIL_CFG_Imp();
	   ConnectionPool connPool_=getConnPool(TX_EMAIL_CFG_DAO.class);
	   Connection conn_=connPool_.getConnection();
	 ...
	 public List selectVO(TX_EMAIL_CFG pData) 
	  throws ConnectionFailedException, DBAccessException{
	 ...
	 public List selectVOFiltred(TX_EMAIL_CFG pData,String pTable,String pFilter) 
	  throws ConnectionFailedException, DBAccessException{
	 ...
	 public List selectVOFiltred(TX_EMAIL_CFG pData,String pFields,String pTable,String pFilter) 
	  throws ConnectionFailedException, DBAccessException{
	 ...
	 public int update(TX_EMAIL_CFG pData) 
	  throws ConnectionFailedException, DBAccessException{
	 ...
	 public int update(TX_EMAIL_CFG pData,String pFilter,Object[] params) 
	  throws ConnectionFailedException, DBAccessException{
	 ...
	 public ConnectionPool getPool() 	  throws ConnectionFailedException, DBAccessException {	   return getConnPool(TX_EMAIL_CFG_DAO.class);
	 }

	 public int insert(TX_EMAIL_CFG pData, boolean isTransaction) 
	  throws ConnectionFailedException, DBAccessException{
	 ...
	 public Integer insertByPK(TX_EMAIL_CFG pData, boolean isTransaction) 
	  throws ConnectionFailedException, DBAccessException{
	 ...
	 public int delete(TX_EMAIL_CFG pData, boolean isTransaction) 
	  throws ConnectionFailedException, DBAccessException{
	 ...
	 public int update(TX_EMAIL_CFG pData, boolean isTransaction) 
	  throws ConnectionFailedException, DBAccessException{
	 ...
	 public int update(TX_EMAIL_CFG pData,String pFilter,Object[] params, boolean isTransaction) 
	  throws ConnectionFailedException, DBAccessException{
