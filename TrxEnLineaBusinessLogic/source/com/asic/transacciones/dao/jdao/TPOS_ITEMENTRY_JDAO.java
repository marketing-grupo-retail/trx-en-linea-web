...
//import .TPOS_ITEMENTRY;

public class TPOS_ITEMENTRY_JDAO extends TransactionalDao_JDAO implements TPOS_ITEMENTRY_DAO  {

	 public int delete(TPOS_ITEMENTRY pData) 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   ConnectionPool connPool_=getConnPool(TPOS_ITEMENTRY_DAO.class);
	 ...
	 public int insert(TPOS_ITEMENTRY pData) 
	  throws ConnectionFailedException, DBAccessException{
	   ...
	   *
	   * Integer id_ = (Integer)getNextId(TPOS_ITEMENTRY_DAO.class,conn_);
	   * pData.setID(id_);
	   */
	 ...
	 public Integer insertByPK(TPOS_ITEMENTRY pData) 
	  throws ConnectionFailedException, DBAccessException{
	 ...
	 public TPOS_ITEMENTRY findByPK(TPOS_ITEMENTRY pData) 
	  throws ConnectionFailedException, DBAccessException{
	   ...
	   */
	   ...
	   try{
	       res_= (TPOS_ITEMENTRY)super.findByPK((DataAdv)pData,conn_);
	   }finally{
	   	connPool_.returnConnection(conn_);
	   }
	 ...
	 public List selectVO() 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   TPOS_ITEMENTRY data_= new TPOS_ITEMENTRY_Imp();
	   ConnectionPool connPool_=getConnPool(TPOS_ITEMENTRY_DAO.class);
	   Connection conn_=connPool_.getConnection();
	 ...
	 public List selectVO(TPOS_ITEMENTRY pData) 
	  throws ConnectionFailedException, DBAccessException{
	 ...
	 public List selectVOFiltred(TPOS_ITEMENTRY pData,String pTable,String pFilter) 
	  throws ConnectionFailedException, DBAccessException{
	 ...
	 public List selectVOFiltred(TPOS_ITEMENTRY pData,String pFields,String pTable,String pFilter) 
	  throws ConnectionFailedException, DBAccessException{
	 ...
	 public int update(TPOS_ITEMENTRY pData) 
	  throws ConnectionFailedException, DBAccessException{
	 ...
	 public int update(TPOS_ITEMENTRY pData,String pFilter,Object[] params) 
	  throws ConnectionFailedException, DBAccessException{
	 ...
	 public ConnectionPool getPool() 	  throws ConnectionFailedException, DBAccessException {	   return getConnPool(TPOS_ITEMENTRY_DAO.class);
	 }

	 public int insert(TPOS_ITEMENTRY pData, boolean isTransaction) 
	  throws ConnectionFailedException, DBAccessException{
	 ...
	 public Integer insertByPK(TPOS_ITEMENTRY pData, boolean isTransaction) 
	  throws ConnectionFailedException, DBAccessException{
	 ...
	 public int delete(TPOS_ITEMENTRY pData, boolean isTransaction) 
	  throws ConnectionFailedException, DBAccessException{
	 ...
	 public int update(TPOS_ITEMENTRY pData, boolean isTransaction) 
	  throws ConnectionFailedException, DBAccessException{
	 ...
	 public int update(TPOS_ITEMENTRY pData,String pFilter,Object[] params, boolean isTransaction) 
	  throws ConnectionFailedException, DBAccessException{
