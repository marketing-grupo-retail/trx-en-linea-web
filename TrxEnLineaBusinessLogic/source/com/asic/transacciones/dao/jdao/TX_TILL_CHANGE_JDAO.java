...
public class TX_TILL_CHANGE_JDAO extends TransactionalDao_JDAO implements TX_TILL_CHANGE_DAO  {
	 ...
	 public int delete(TX_TILL_CHANGE pData) 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   ConnectionPool connPool_=getConnPool(TX_TILL_CHANGE_DAO.class);
	 ...
	 public int insert(TX_TILL_CHANGE pData) 
	   ...
	   *
	   * Integer id_ = (Integer)getNextId(TX_TILL_CHANGE_DAO.class,conn_);
	   * pData.setID(id_);
	   */
	 ...
	 public TX_TILL_CHANGE findByPK(TX_TILL_CHANGE pData) 
	   ...
	   */
	   ...
	   try{
	       res_= (TX_TILL_CHANGE)super.findByPK((DataAdv)pData,conn_);
	   }finally{
	   	connPool_.returnConnection(conn_);
	   }
	 ...
	 public List selectVO() 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   TX_TILL_CHANGE data_= new TX_TILL_CHANGE_Imp();
	   ConnectionPool connPool_=getConnPool(TX_TILL_CHANGE_DAO.class);
	   Connection conn_=connPool_.getConnection();
	 ...
	 public ConnectionPool getPool() 	  throws ConnectionFailedException, DBAccessException {	   return getConnPool(TX_TILL_CHANGE_DAO.class);
	 }
