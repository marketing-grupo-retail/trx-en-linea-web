...
import com.asic.transacciones.dao.TX_PROCESO_DAO;
import com.asic.transacciones.vo.TX_PROCESO;
import com.asic.transacciones.vo.TX_PROCESO_Imp;

//import .TX_PROCESO;

public class TX_PROCESO_JDAO extends TransactionalDao_JDAO implements TX_PROCESO_DAO  {
	 ...
	 public int delete(TX_PROCESO pData) 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   ConnectionPool connPool_=getConnPool(TX_PROCESO_DAO.class);
	 ...
	 public int insert(TX_PROCESO pData) 
	   ...
	   *
	   * Integer id_ = (Integer)getNextId(TX_PROCESO_DAO.class,conn_);
	   * pData.setID(id_);
	   */
	 ...
	 public TX_PROCESO findByPK(TX_PROCESO pData) 
	   ...
	   */
	   ...
	   try{
	       res_= (TX_PROCESO)super.findByPK((DataAdv)pData,conn_);
	   }finally{
	   	connPool_.returnConnection(conn_);
	   }
	 ...
	 public List selectVO() 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   TX_PROCESO data_= new TX_PROCESO_Imp();
	   ConnectionPool connPool_=getConnPool(TX_PROCESO_DAO.class);
	   Connection conn_=connPool_.getConnection();
	 ...
	 public ConnectionPool getPool() 	  throws ConnectionFailedException, DBAccessException {	   return getConnPool(TX_PROCESO_DAO.class);
	 }
