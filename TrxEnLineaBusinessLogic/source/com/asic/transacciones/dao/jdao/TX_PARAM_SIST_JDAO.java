...
import com.asic.transacciones.dao.TX_PARAM_SIST_DAO;
import com.asic.transacciones.vo.TX_PARAM_SIST;
import com.asic.transacciones.vo.TX_PARAM_SIST_Imp;

//import .TX_PARAM_SIST;

public class TX_PARAM_SIST_JDAO extends TransactionalDao_JDAO implements TX_PARAM_SIST_DAO  {

	 public int delete(TX_PARAM_SIST pData) 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   ConnectionPool connPool_=getConnPool(TX_PARAM_SIST_DAO.class);
	 ...
	 public int insert(TX_PARAM_SIST pData) 
	  throws ConnectionFailedException, DBAccessException{
	   ...
	   *
	   * Integer id_ = (Integer)getNextId(TX_PARAM_SIST_DAO.class,conn_);
	   * pData.setID(id_);
	   */
	 ...
	 public Integer insertByPK(TX_PARAM_SIST pData) 
	  throws ConnectionFailedException, DBAccessException{
	 ...
	 public TX_PARAM_SIST findByPK(TX_PARAM_SIST pData) 
	  throws ConnectionFailedException, DBAccessException{
	   ...
	   */
	   ...
	   try{
	       res_= (TX_PARAM_SIST)super.findByPK((DataAdv)pData,conn_);
	   }finally{
	   	connPool_.returnConnection(conn_);
	   }
	 ...
	 public List selectVO() 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   TX_PARAM_SIST data_= new TX_PARAM_SIST_Imp();
	   ConnectionPool connPool_=getConnPool(TX_PARAM_SIST_DAO.class);
	   Connection conn_=connPool_.getConnection();
	 ...
	 public List selectVO(TX_PARAM_SIST pData) 
	  throws ConnectionFailedException, DBAccessException{
	 ...
	 public List selectVOFiltred(TX_PARAM_SIST pData,String pTable,String pFilter) 
	  throws ConnectionFailedException, DBAccessException{
	 ...
	 public List selectVOFiltred(TX_PARAM_SIST pData,String pFields,String pTable,String pFilter) 
	  throws ConnectionFailedException, DBAccessException{
	 ...
	 public int update(TX_PARAM_SIST pData) 
	  throws ConnectionFailedException, DBAccessException{
	 ...
	 public int update(TX_PARAM_SIST pData,String pFilter,Object[] params) 
	  throws ConnectionFailedException, DBAccessException{
	 ...
	 public ConnectionPool getPool() 	  throws ConnectionFailedException, DBAccessException {	   return getConnPool(TX_PARAM_SIST_DAO.class);
	 }

	 public int insert(TX_PARAM_SIST pData, boolean isTransaction) 
	  throws ConnectionFailedException, DBAccessException{
	 ...
	 public Integer insertByPK(TX_PARAM_SIST pData, boolean isTransaction) 
	  throws ConnectionFailedException, DBAccessException{
	 ...
	 public int delete(TX_PARAM_SIST pData, boolean isTransaction) 
	  throws ConnectionFailedException, DBAccessException{
	 ...
	 public int update(TX_PARAM_SIST pData, boolean isTransaction) 
	  throws ConnectionFailedException, DBAccessException{
	 ...
	 public int update(TX_PARAM_SIST pData,String pFilter,Object[] params, boolean isTransaction) 
	  throws ConnectionFailedException, DBAccessException{
