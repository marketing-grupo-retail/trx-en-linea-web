...
public class TPOS_MANAGER_OVERRIDE_JDAO extends TransactionalDao_JDAO implements TPOS_MANAGER_OVERRIDE_DAO  {
	 ...
	 public int delete(TPOS_MANAGER_OVERRIDE pData) 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   ConnectionPool connPool_=getConnPool(TPOS_MANAGER_OVERRIDE_DAO.class);
	 ...
	 public int insert(TPOS_MANAGER_OVERRIDE pData) 
	   ...
	   *
	   * Integer id_ = (Integer)getNextId(TPOS_MANAGER_OVERRIDE_DAO.class,conn_);
	   * pData.setID(id_);
	   */
	 ...
	 public TPOS_MANAGER_OVERRIDE findByPK(TPOS_MANAGER_OVERRIDE pData) 
	   ...
	   */
	   ...
	   TPOS_MANAGER_OVERRIDE res_;

	   try{
	       res_= (TPOS_MANAGER_OVERRIDE)super.findByPK((DataAdv)pData,conn_);
	   }finally{
	   	connPool_.returnConnection(conn_);
	   }
	 ...
	 public List selectVO() 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   TPOS_MANAGER_OVERRIDE data_= new TPOS_MANAGER_OVERRIDE_Imp();
	   ConnectionPool connPool_=getConnPool(TPOS_MANAGER_OVERRIDE_DAO.class);
	   Connection conn_=connPool_.getConnection();
	 ...
	 public ConnectionPool getPool() 	  throws ConnectionFailedException, DBAccessException {	   return getConnPool(TPOS_MANAGER_OVERRIDE_DAO.class);
	 }
