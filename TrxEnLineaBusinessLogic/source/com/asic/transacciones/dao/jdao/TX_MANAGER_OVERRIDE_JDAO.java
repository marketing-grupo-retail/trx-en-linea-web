...
public class TX_MANAGER_OVERRIDE_JDAO extends TransactionalDao_JDAO implements TX_MANAGER_OVERRIDE_DAO  {
	 ...
	 public int delete(TX_MANAGER_OVERRIDE pData) 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   ConnectionPool connPool_=getConnPool(TX_MANAGER_OVERRIDE_DAO.class);
	 ...
	 public int insert(TX_MANAGER_OVERRIDE pData) 
	   ...
	   *
	   * Integer id_ = (Integer)getNextId(TX_MANAGER_OVERRIDE_DAO.class,conn_);
	   * pData.setID(id_);
	   */
	 ...
	 public TX_MANAGER_OVERRIDE findByPK(TX_MANAGER_OVERRIDE pData) 
	   ...
	   */
	   ...
	   TX_MANAGER_OVERRIDE res_;

	   try{
	       res_= (TX_MANAGER_OVERRIDE)super.findByPK((DataAdv)pData,conn_);
	   }finally{
	   	connPool_.returnConnection(conn_);
	   }
	 ...
	 public List selectVO() 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   TX_MANAGER_OVERRIDE data_= new TX_MANAGER_OVERRIDE_Imp();
	   ConnectionPool connPool_=getConnPool(TX_MANAGER_OVERRIDE_DAO.class);
	   Connection conn_=connPool_.getConnection();
	 ...
	 public ConnectionPool getPool() 	  throws ConnectionFailedException, DBAccessException {	   return getConnPool(TX_MANAGER_OVERRIDE_DAO.class);
	 }
