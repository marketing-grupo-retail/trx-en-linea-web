...
public class TPOS_USER_DATA_JDAO extends TransactionalDao_JDAO implements TPOS_USER_DATA_DAO  {
	 ...
	 public int delete(TPOS_USER_DATA pData) 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   ConnectionPool connPool_=getConnPool(TPOS_USER_DATA_DAO.class);
	 ...
	 public int insert(TPOS_USER_DATA pData) 
	   ...
	   *
	   * Integer id_ = (Integer)getNextId(TPOS_USER_DATA_DAO.class,conn_);
	   * pData.setID(id_);
	   */
	 ...
	 public TPOS_USER_DATA findByPK(TPOS_USER_DATA pData) 
	   ...
	   */
	   ...
	   try{
	       res_= (TPOS_USER_DATA)super.findByPK((DataAdv)pData,conn_);
	   }finally{
	   	connPool_.returnConnection(conn_);
	   }
	 ...
	 public List selectVO() 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   TPOS_USER_DATA data_= new TPOS_USER_DATA_Imp();
	   ConnectionPool connPool_=getConnPool(TPOS_USER_DATA_DAO.class);
	   Connection conn_=connPool_.getConnection();
	 ...
	 public ConnectionPool getPool() 	  throws ConnectionFailedException, DBAccessException {	   return getConnPool(TPOS_USER_DATA_DAO.class);
	 }
