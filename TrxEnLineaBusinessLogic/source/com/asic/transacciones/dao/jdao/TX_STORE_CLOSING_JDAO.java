...
public class TX_STORE_CLOSING_JDAO extends TransactionalDao_JDAO implements TX_STORE_CLOSING_DAO  {
	 ...
	 public int delete(TX_STORE_CLOSING pData) 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   ConnectionPool connPool_=getConnPool(TX_STORE_CLOSING_DAO.class);
	 ...
	 public int insert(TX_STORE_CLOSING pData) 
	   ...
	   *
	   * Integer id_ = (Integer)getNextId(TX_STORE_CLOSING_DAO.class,conn_);
	   * pData.setID(id_);
	   */
	 ...
	 public TX_STORE_CLOSING findByPK(TX_STORE_CLOSING pData) 
	   ...
	   */
	   ...
	   TX_STORE_CLOSING res_;

	   try{
	       res_= (TX_STORE_CLOSING)super.findByPK((DataAdv)pData,conn_);
	   }finally{
	   	connPool_.returnConnection(conn_);
	   }
	 ...
	 public List selectVO() 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   TX_STORE_CLOSING data_= new TX_STORE_CLOSING_Imp();
	   ConnectionPool connPool_=getConnPool(TX_STORE_CLOSING_DAO.class);
	   Connection conn_=connPool_.getConnection();
	 ...
	 public ConnectionPool getPool() 	  throws ConnectionFailedException, DBAccessException {	   return getConnPool(TX_STORE_CLOSING_DAO.class);
	 }
