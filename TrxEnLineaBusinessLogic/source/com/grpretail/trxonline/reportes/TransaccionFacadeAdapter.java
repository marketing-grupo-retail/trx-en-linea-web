 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class TransaccionFacadeAdapter implements TransaccionBusinessDelegate {

	private TransaccionBean bean_ = null;
	...
	public List getTransacciones(TPOS_HEADER pHeader, int pPosIni, int pPosFin) throws ServiceException {
		bean_ = new TransaccionBean();
		return bean_.getTransacciones(pHeader, pPosIni, pPosFin);
	}
	...
	public TRANSACCION getDetalleTransacciones(TPOS_HEADER pHeader, int pPosIni, int pPosFin) throws ServiceException {
		bean_ = new TransaccionBean();
		return bean_.getDetalleTransacciones(pHeader, pPosIni, pPosFin);
	}
