 ...
 * * All rights Reserved.
 *
 * $Id: PERFIL_Imp.java,v 1.1 2019/12/18 17:08:58 Alfonso Exp $
 *
 */
package com.grpretail.business.admin.vo;

/**
 * Clase que permite acceso a la tabla PERFIL y a sus atributos.
 *
 * @author: null.
 * @version: null
 */
...
public class PERFIL_Imp extends jdao.data.DataAdv implements PERFIL, Serializable {


	/**
	 * Atributo que contiene el nombre de la tabla <B>PERFIL</B>
	 */
	public static final String NAME = "MOL_PERFIL";
	/**
...
/**
 * Crea un nuevo PERFIL con los campos de la llave primaria
 * @param _ID java.lang.Integer;
 */
public PERFIL_Imp( java.lang.Integer _ID) {
	this._ID = _ID;
}
	/**
	 * Crea un nuevo PERFIL con los campos de la tabla
	 * @param pID java.lang.Integer;
	 * @param pNOMBRE java.lang.String;
	 * @param pDESCRIP java.lang.String;
	 */
	public PERFIL_Imp( java.lang.Integer pID,java.lang.String pNOMBRE,java.lang.String pDESCRIP) {
		this._ID = pID;
	...
	/**
	 * Retorna el nombre de la tabla PERFIL
	...
	/**
	 * Inicia la configuracion de la tabla PERFIL
	 */
	public void start() {
