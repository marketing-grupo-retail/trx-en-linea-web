 ...
 * * All rights Reserved.
 *
 * $Id: DETSERV_JDAO.java,v 1.1 2019/12/18 17:08:54 Alfonso Exp $
 *
 */
...
import com.grpretail.business.admin.vo.DETSERV;
import com.grpretail.business.admin.vo.DETSERV_Imp;
 ...
 */
public class DETSERV_JDAO extends AbstractDAO_JDAO implements DETSERV_DAO {
    /**
     * JDOC Method Def
     *
     ...
     */
    public int delete(DETSERV pData)
        ...
        ConnectionPool connPool_ = getConnPool(DETSERV_DAO.class);
     ...
     * @throws DBAccessException DOCUMENT ME!
     */
    public int insert(DETSERV pData)
        throws ConnectionFailedException, DBAccessException {
        // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
        ConnectionPool connPool_ = getConnPool(DETSERV_DAO.class);
        Connection conn_ = connPool_.getConnection();
         ...
         *
         * Integer id_ = (Integer)getNextId(DETSERV_DAO.class,conn_);
         * pData.setID(id_);
         */
        /*
         * Ejemplo utilizando transacciones
     ...
     * @throws DBAccessException DOCUMENT ME!
     */
    public DETSERV findByPK(DETSERV pData)
        throws ConnectionFailedException, DBAccessException {
        // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
        ConnectionPool connPool_ = getConnPool(DETSERV_DAO.class);
        Connection conn_ = connPool_.getConnection();
        ...
        try {
            res_ = (DETSERV) super.findByPK((DataAdv) pData, conn_);
        } finally {
            connPool_.returnConnection(conn_);
        }
     ...
     * @throws DBAccessException DOCUMENT ME!
     */
    public List selectVO(DETSERV pData)
        throws ConnectionFailedException, DBAccessException {
        // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
        ConnectionPool connPool_ = getConnPool(DETSERV_DAO.class);
        Connection conn_ = connPool_.getConnection();
     ...
     * @throws DBAccessException DOCUMENT ME!
     */
    public List selectVOFiltred(DETSERV pData, String pTable, String pFilter)
        throws ConnectionFailedException, DBAccessException {
        // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
        ConnectionPool connPool_ = getConnPool(DETSERV_DAO.class);
        Connection conn_ = connPool_.getConnection();
     ...
     * @throws DBAccessException DOCUMENT ME!
     */
    public List selectVOFiltred(DETSERV pData, String pFields, String pTable,
     ...
     * @throws DBAccessException DOCUMENT ME!
     */
    public int update(DETSERV pData)
        throws ConnectionFailedException, DBAccessException {
        // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
        ConnectionPool connPool_ = getConnPool(DETSERV_DAO.class);
        Connection conn_ = connPool_.getConnection();
     ...
     * @throws DBAccessException DOCUMENT ME!
     */
    public int update(DETSERV pData, String pFilter, Object[] params)
        throws ConnectionFailedException, DBAccessException {
        // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
        ConnectionPool connPool_ = getConnPool(DETSERV_DAO.class);
        Connection conn_ = connPool_.getConnection();
