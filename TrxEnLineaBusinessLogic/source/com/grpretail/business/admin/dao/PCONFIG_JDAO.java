 ...
 * * All rights Reserved.
 *
 * $Id: PCONFIG_JDAO.java,v 1.1 2019/12/18 17:08:55 Alfonso Exp $
 *
 */
 ...
 */
public class PCONFIG_JDAO extends AbstractDAO_JDAO implements PCONFIG_DAO {
    /**
     * JDOC Method Def
     *
    ...
    public int delete(PCONFIG pData)
        ...
        ConnectionPool connPool_ = getConnPool(PCONFIG_DAO.class);
    ...
    public int insert(PCONFIG pData)
         ...
         *
         * Integer id_ = (Integer)getNextId(PCONFIG_DAO.class,conn_);
         * pData.setID(id_);
         */
        /*
         * Ejemplo utilizando transacciones
    ...
    public PCONFIG findByPK(PCONFIG pData)
        ...
        try {
            res_ = (PCONFIG) super.findByPK((DataAdv) pData, conn_);
        } finally {
            connPool_.returnConnection(conn_);
        }
