...
import com.grpretail.business.admin.vo.LOG_PROP_Imp;

public class LOG_PROP_JDAO extends AbstractDAO_JDAO implements LOG_PROP_DAO {
	 ...
	 public int delete(LOG_PROP pData)
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   ConnectionPool connPool_=getConnPool(LOG_PROP_DAO.class);
	 ...
	 public int insert(LOG_PROP pData)
	  ...
	  // Ejemplo de asignacion de Ids consecutivos
	    ...
	    Integer id_ = (Integer)getNextId(LOG_PROP_DAO.class,conn_);
	    pData.setID(id_);
	 ...
	 public LOG_PROP findByPK(LOG_PROP pData)
	   ...
	   */
	   ...
	   try{
	       res_= (LOG_PROP)super.findByPK((DataAdv)pData,conn_);
	   }finally{
	   	connPool_.returnConnection(conn_);
	   }
	 ...
	 public List selectVO()
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   LOG_PROP data_= new LOG_PROP_Imp();
	   ConnectionPool connPool_=getConnPool(LOG_PROP_DAO.class);
	   Connection conn_=connPool_.getConnection();
