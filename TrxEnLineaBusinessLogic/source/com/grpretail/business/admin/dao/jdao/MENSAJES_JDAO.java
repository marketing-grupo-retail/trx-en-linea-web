...
public class MENSAJES_JDAO extends AbstractDAO_JDAO implements MENSAJES_DAO {
	 ...
	 public int delete(MENSAJES pData)
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   ConnectionPool connPool_=getConnPool(MENSAJES_DAO.class);
	 ...
	 public int insert(MENSAJES pData)
	   ...
	   */
	   Integer id_ = (Integer)getNextId(MENSAJES_DAO.class,conn_);
	   pData.setID(id_);
	 ...
	 public MENSAJES findByPK(MENSAJES pData)
	   ...
	   */
	   ...
	   try{
	       res_= (MENSAJES)super.findByPK((DataAdv)pData,conn_);
	   }finally{
	   	connPool_.returnConnection(conn_);
	   }
	 ...
	 public List selectVO()
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   MENSAJES data_= new MENSAJES_Imp();
	   ConnectionPool connPool_=getConnPool(MENSAJES_DAO.class);
	   Connection conn_=connPool_.getConnection();
