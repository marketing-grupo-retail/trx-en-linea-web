...
import com.grpretail.business.admin.vo.MENSXPRF_Imp;

public class MENSXPRF_JDAO extends AbstractDAO_JDAO implements MENSXPRF_DAO {
	 ...
	 public int delete(MENSXPRF pData) 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   ConnectionPool connPool_=getConnPool(MENSXPRF_DAO.class);
	 ...
	 public int insert(MENSXPRF pData) 
	   ...
	   */
	   Integer id_ = (Integer)getNextId(MENSXPRF_DAO.class,conn_);
	   pData.setID(id_);
	 ...
	 public MENSXPRF findByPK(MENSXPRF pData) 
	   ...
	   */
	   ...
	   try{
	       res_= (MENSXPRF)super.findByPK((DataAdv)pData,conn_);
	   }finally{
	   	connPool_.returnConnection(conn_);
	   }
	 ...
	 public List selectVO() 
	  ...
	  // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
	   MENSXPRF data_= new MENSXPRF_Imp();
	   ConnectionPool connPool_=getConnPool(MENSXPRF_DAO.class);
	   Connection conn_=connPool_.getConnection();
