 ...
 * * All rights Reserved.
 *
 * $Id: DSPEMAIL_JDAO.java,v 1.1 2019/12/18 17:08:56 Alfonso Exp $
 *
 */
...
import com.grpretail.business.admin.vo.DSPEMAIL_Imp;
 ...
 */
public class DSPEMAIL_JDAO extends AbstractDAO_JDAO implements DSPEMAIL_DAO {
    /**
     * JDOC Method Def
     *
    ...
    public int delete(DSPEMAIL pData)
        ...
        ConnectionPool connPool_ = getConnPool(DSPEMAIL_DAO.class);
    ...
    public int insert(DSPEMAIL pData)
        ...
        Connection conn_ = connPool_.getConnection();
         ...
         // Ejemplo de asignacion de Ids consecutivos
          ...
          Integer id_ = (Integer)getNextId(DSPEMAIL_DAO.class,conn_);
          pData.setID(id_);
    ...
    public DSPEMAIL findByPK(DSPEMAIL pData)
        ...
        try {
            res_ = (DSPEMAIL) super.findByPK((DataAdv) pData, conn_);
        } finally {
            connPool_.returnConnection(conn_);
        }
    ...
    public List selectVO() throws ConnectionFailedException, DBAccessException {
        // obtiene la conexion a partir del nombre de la interfaz en el dao.properties
        DSPEMAIL data_ = new DSPEMAIL_Imp();
        ConnectionPool connPool_ = getConnPool(DSPEMAIL_DAO.class);
        Connection conn_ = connPool_.getConnection();
