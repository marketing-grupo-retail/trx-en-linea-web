...
public class StoreProcedureException extends Exception {
	...
	*/
	 ...
	 * @param s
	 */
	public StoreProcedureException(String s) {
		super(s);
	}
	 ...
	 * @param s
	 */
	public StoreProcedureException(String s, Throwable rootCause) {
		super(s);
	 ...
	 * @param s
	 */
	public StoreProcedureException(String s, String errorCode) {
		super(s);
	 ...
	 * @param s
	 */
	public StoreProcedureException(String s, String errorCode, Throwable cause) {
		this(s, errorCode);
