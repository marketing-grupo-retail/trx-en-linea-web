 ...
 */
public class TransactionExistsException extends ServiceException {
	...
	*/
	 ...
	 * @param s
	 */
	public TransactionExistsException(String s, Throwable rootCause) {
		super(s);
	 ...
	 * @param s
	 */
	public TransactionExistsException(String s, String errorCode) {
		super(s);
	 ...
	 * @param s
	 */
	public TransactionExistsException(String s, String errorCode, Throwable cause) {
		this(s, errorCode);
